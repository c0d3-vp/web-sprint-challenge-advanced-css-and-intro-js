...
function get20s(array, date1, date2){
let result = [];
  for (let i = 0; i < array.length; i++) {
    let [born, died] = array[i]['years'].split(' - ');
    if (Number(born) >= date1 && Number(died) <= date2) {
...
bio: 'Specializes in backend development.  Is a wizz with Python.'}));
